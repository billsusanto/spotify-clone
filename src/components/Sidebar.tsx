...
export default function Sidebar() {
  ...
  return (
    <aside
      className="hidden md:flex md:flex-col w-[280px] bg-spotify-black p-6 gap-6 font-inter"
    ...
    >
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                'hover:bg-white/10',
                isActive && 'bg-spotify-dark-gray border-l-[3px] border-spotify-green'
              )}
      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        <div className="flex-1 overflow-y-auto space-y-2 scrollbar-thin" role="list" aria-label="Your playlists">
